...
func TestImage(t *testing.T) {
	...
	var ctx = context.Background()
	var signer = GetYourPrivateKey()
	var image = Must1(base64.StdEncoding.DecodeString(testLogo))
